TradeCenter_MapScriptHeader:
	...
	db 2 ; object events
	object_event  3,  4, SPRITE_PLAYER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, START_OF_CYCLE_EXIST, END_OF_CYCLE_EXIST, OW_NPC1, PAL_NPC_PURPLE, PERSONTYPE_SCRIPT, 0, ChrisScript_0x193499, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
	object_event  6,  4, SPRITE_PLAYER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, START_OF_CYCLE_EXIST, END_OF_CYCLE_EXIST, OW_NPC1, PAL_NPC_PURPLE, PERSONTYPE_SCRIPT, 0, ChrisScript_0x193499, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_2
