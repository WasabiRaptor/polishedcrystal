...
DanielsTown_MapScriptHeader:
	...
	object_event  7, 16, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, START_OF_CYCLE_EXIST, END_OF_CYCLE_EXIST, OW_NPC1, PAL_NPC_RED, PERSONTYPE_TRAINER, 2, TrainerYoungsterJoey, -1
