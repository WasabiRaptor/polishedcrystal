AzaleaPokeCenter1F_MapScriptHeader:
	...
	db 5 ; object events
	pc_nurse_event  5, 1
	object_event  8,  4, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_COPY_PLAYER, PERSONTYPE_SCRIPT, 0, AzaleaPokeCenter1FCooltrainermScript, -1
