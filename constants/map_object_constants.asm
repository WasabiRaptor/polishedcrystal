...
; map object struct
	...
	const MAPOBJECT_CYCLE_START_HOUR ; 6
	const MAPOBJECT_CYCLE_END_HOUR ; 7
	const MAPOBJECT_COLOR ; 8
	const MAPOBJECT_COLOR_2 ; 9
	const MAPOBJECT_RANGE ; a
	const MAPOBJECT_SCRIPT_POINTER ; b
	const MAPOBJECT_POINTER_HI ; c
	const MAPOBJECT_EVENT_FLAG ; d
	const MAPOBJECT_FLAG_HI ; e
OBJECT_LENGTH EQU const_value

MAPOBJECT_DAILY_F 	EQU 7

MAPOBJECT_DAILY 	EQU 1 << MAPOBJECT_DAILY_F
MAPOBJECT_HOUR_MASK EQU %01111111

MAPOBJECT_SCREEN_HEIGHT EQU 11
MAPOBJECT_SCREEN_WIDTH EQU 12

START_OF_CYCLE_EXIST 	EQU MAPOBJECT_HOUR_MASK
END_OF_CYCLE_EXIST 		EQU 0
