...
COLL_ELEVATOR_BUTTON   EQU $b4
COLL_UNSAFE_FLOOR      EQU $b5

COLL_STAIRS_RIGHT_DOWN EQU $d0
COLL_STAIRS_LEFT_DOWN  EQU $d1
COLL_STAIRS_RIGHT_UP EQU $d2
COLL_STAIRS_LEFT_UP  EQU $d3
COLL_STAIRS_RIGHT_UP_FLAT EQU $d4
COLL_STAIRS_LEFT_UP_FLAT  EQU $d5
COLL_STAIRS_RIGHT_UP_MID EQU $d6
COLL_STAIRS_LEFT_UP_MID  EQU $d7
COLL_STAIRS_RIGHT_UP_BOTTOM EQU $d8
COLL_STAIRS_LEFT_UP_BOTTOM  EQU $d9
COLL_STAIRS_RIGHT_UP_TOP EQU $da
COLL_STAIRS_LEFT_UP_TOP  EQU $db
COLL_STAIRS_RIGHT_UP_HALF EQU $dc
COLL_STAIRS_LEFT_UP_HALF EQU $dd
