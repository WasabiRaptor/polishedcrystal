	...
	const MONMENU_FOLLOW     ; 19
	const MONMENU_STOPFOLLOW ; 20
...
; PartyMenuActionText
	...
	const_def
	const MONSUBMENU_CHOOSE
	const MONSUBMENU_NORELOAD
	const MONSUBMENU_QUIT
	const MONSUBMENU_RELOAD

BACKUP_TILES EQU (1 << 6)
MENU2_ONE_X EQU (1 << 7)
MENU2_ONE_Y EQU (1 << 6)

    const_def 1
    const FOLLOWER_MENU_ACTION_PLAY
    const FOLLOWER_MENU_ACTION_FLY
    const FOLLOWER_MENU_ACTION_DIG
    const FOLLOWER_MENU_ACTION_TELEPORT
    const FOLLOWER_MENU_ACTION_HEAL
    const FOLLOWER_MENU_ACTION_LEAD
    const FOLLOWER_MENU_ACTION_SWITCH
    const FOLLOWER_MENU_ACTION_STAY
NUM_FOLLOWER_WITHIN_MENU_ACTIONS EQU const_value +-1
