...
; wPlayerOverworldStatus
PLAYER_IS_POKEMON_F 		EQU 0
PLAYER_RIDING_POKEMON_F 	EQU 1
PLAYER_BIKING_F 			EQU 2
PLAYER_CONTROL_FOLLOWER_F 	EQU 3
PLAYER_PARTY_SPLIT_F 		EQU 4

PLAYER_IS_POKEMON 		EQU 1 << PLAYER_IS_POKEMON_F
PLAYER_RIDING_POKEMON 	EQU 1 << PLAYER_RIDING_POKEMON_F
PLAYER_BIKING 			EQU 1 << PLAYER_BIKING_F
PLAYER_CONTROL_FOLLOWER EQU 1 << PLAYER_CONTROL_FOLLOWER_F
PLAYER_PARTY_SPLIT 		EQU 1 << PLAYER_PARTY_SPLIT_F


OBJECT_STRUCT_LENGTH EQU 33
NUM_OBJECT_STRUCTS EQU 13
FIRST_VRAM1_OBJECT_STRUCT EQU 6
