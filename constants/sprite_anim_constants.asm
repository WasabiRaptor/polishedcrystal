...
; see data/sprite_anims/framesets.asm:SpriteAnimFrameData
	...
	const SPRITE_ANIM_FRAMESET_BRASS_TITLE
...
;	const SPRITE_ANIM_INDEX_DUMMY_GAME
	...
	const SPRITE_ANIM_INDEX_BRASS_TITLE
...
; see data/sprite_engine.asm:SpriteAnimOAMData
	...
	const SPRITE_ANIM_FRAME_PARTY_FRAME_3
	const SPRITE_ANIM_FRAME_PARTY_ITEM_FRAME_3
	const SPRITE_ANIM_FRAME_BRASS_TITLE
