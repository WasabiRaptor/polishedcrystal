...
SECTION "Johto Pokemon Pics 1", ROMX
...
SECTION "Johto Pokemon Pics 2", ROMX
...
SECTION "Johto Pokemon Pics 3", ROMX

PichuFrontpic::	INCBIN "gfx/pokemon/pichu/front.animated.2bpp.lz"
PichuBackpic::	INCBIN "gfx/pokemon/pichu/back.2bpp.lz"
PichuSpiky_earedFrontpic::	INCBIN "gfx/pokemon/pichu_spiky_eared/front.animated.2bpp.lz"
PichuSpiky_earedBackpic::	INCBIN "gfx/pokemon/pichu_spiky_eared/back.2bpp.lz"
...
AmpharosMegaFrontpic::	INCBIN "gfx/pokemon/ampharos_mega/front.animated.2bpp.lz"
AmpharosMegaBackpic::	INCBIN "gfx/pokemon/ampharos_mega/back.2bpp.lz"


SECTION "Johto Pokemon Pics 4", ROMX
...
SECTION "Johto Pokemon Pics 5", ROMX
...
UnownExclamation_markFrontpic::	INCBIN "gfx/pokemon/unown_exclamation_mark/front.animated.2bpp.lz"
UnownExclamation_markBackpic::	INCBIN "gfx/pokemon/unown_exclamation_mark/back.2bpp.lz"
UnownQuestion_markFrontpic::	INCBIN "gfx/pokemon/unown_question_mark/front.animated.2bpp.lz"
UnownQuestion_markBackpic::	INCBIN "gfx/pokemon/unown_question_mark/back.2bpp.lz"


SECTION "Johto Pokemon Pics 6", ROMX
...
SteelixMegaFrontpic::	INCBIN "gfx/pokemon/steelix_mega/front.animated.2bpp.lz"
SteelixMegaBackpic::	INCBIN "gfx/pokemon/steelix_mega/back.2bpp.lz"
...
SECTION "Johto Pokemon Pics 7", ROMX

ScizorFrontpic::	INCBIN "gfx/pokemon/scizor/front.animated.2bpp.lz"
ScizorBackpic::	INCBIN "gfx/pokemon/scizor/back.2bpp.lz"
ScizorMegaFrontpic::	INCBIN "gfx/pokemon/scizor_mega/front.animated.2bpp.lz"
ScizorMegaBackpic::	INCBIN "gfx/pokemon/scizor_mega/back.2bpp.lz"
...
HeracrossMegaFrontpic::	INCBIN "gfx/pokemon/heracross_mega/front.animated.2bpp.lz"
HeracrossMegaBackpic::	INCBIN "gfx/pokemon/heracross_mega/back.2bpp.lz"
...
SECTION "Johto Pokemon Pics 8", ROMX

CorsolaFrontpic::	INCBIN "gfx/pokemon/corsola/front.animated.2bpp.lz"
CorsolaBackpic::	INCBIN "gfx/pokemon/corsola/back.2bpp.lz"
CorsolaGalarFrontpic::	INCBIN "gfx/pokemon/corsola_galar/front.animated.2bpp.lz"
CorsolaGalarBackpic::	INCBIN "gfx/pokemon/corsola_galar/back.2bpp.lz"
...
HoundoomMegaFrontpic::	INCBIN "gfx/pokemon/houndoom_mega/front.animated.2bpp.lz"
HoundoomMegaBackpic::	INCBIN "gfx/pokemon/houndoom_mega/back.2bpp.lz"
...
SECTION "Johto Pokemon Pics 9", ROMX
...
SECTION "Johto Pokemon Pics 10", ROMX
...
TyranitarMegaFrontpic::	INCBIN "gfx/pokemon/tyranitar_mega/front.animated.2bpp.lz"
TyranitarMegaBackpic::	INCBIN "gfx/pokemon/tyranitar_mega/back.2bpp.lz"
