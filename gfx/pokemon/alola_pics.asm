...
SECTION "Alola Pokemon Pics 1", ROMX
...
SECTION "Alola Pokemon Pics 4", ROMX
...
SECTION "Alola Pokemon Pics 5", ROMX
...
ComfeyFrontpic::	INCBIN "gfx/pokemon/comfey/front.animated.2bpp.lz"
...
SECTION "Alola Pokemon Pics 6", ROMX

Type_nullFrontpic::	INCBIN "gfx/pokemon/type_null/front.animated.2bpp.lz"
Type_nullBackpic::	INCBIN "gfx/pokemon/type_null/back.2bpp.lz"
...
SECTION "Alola Pokemon Pics 7", ROMX
...
Tapu_kokoFrontpic::	INCBIN "gfx/pokemon/tapu_koko/front.animated.2bpp.lz"
Tapu_kokoBackpic::	INCBIN "gfx/pokemon/tapu_koko/back.2bpp.lz"

Tapu_leleFrontpic::	INCBIN "gfx/pokemon/tapu_lele/front.animated.2bpp.lz"
Tapu_leleBackpic::	INCBIN "gfx/pokemon/tapu_lele/back.2bpp.lz"

Tapu_buluFrontpic::	INCBIN "gfx/pokemon/tapu_bulu/front.animated.2bpp.lz"
Tapu_buluBackpic::	INCBIN "gfx/pokemon/tapu_bulu/back.2bpp.lz"

Tapu_finiFrontpic::	INCBIN "gfx/pokemon/tapu_fini/front.animated.2bpp.lz"
Tapu_finiBackpic::	INCBIN "gfx/pokemon/tapu_fini/back.2bpp.lz"

CosmogFrontpic::	INCBIN "gfx/pokemon/cosmog/front.animated.2bpp.lz"
CosmogBackpic::	INCBIN "gfx/pokemon/cosmog/back.2bpp.lz"

CosmoemFrontpic::	INCBIN "gfx/pokemon/cosmoem/front.animated.2bpp.lz"
CosmoemBackpic::	INCBIN "gfx/pokemon/cosmoem/back.2bpp.lz"

SolgaleoFrontpic::	INCBIN "gfx/pokemon/solgaleo/front.animated.2bpp.lz"
SolgaleoBackpic::	INCBIN "gfx/pokemon/solgaleo/back.2bpp.lz"


SECTION "Alola Pokemon Pics 8", ROMX

LunalaFrontpic::	INCBIN "gfx/pokemon/lunala/front.animated.2bpp.lz"
LunalaBackpic::	INCBIN "gfx/pokemon/lunala/back.2bpp.lz"
...
SECTION "Alola Pokemon Pics 9", ROMX
...
PoipoleFrontpic::	INCBIN "gfx/pokemon/poipole/front.animated.2bpp.lz"
PoipoleBackpic::	INCBIN "gfx/pokemon/poipole/back.2bpp.lz"

NaganadelFrontpic::	INCBIN "gfx/pokemon/naganadel/front.animated.2bpp.lz"
NaganadelBackpic::	INCBIN "gfx/pokemon/naganadel/back.2bpp.lz"
...
ZeraoraFrontpic::	INCBIN "gfx/pokemon/zeraora/front.animated.2bpp.lz"
ZeraoraBackpic::	INCBIN "gfx/pokemon/zeraora/back.2bpp.lz"
