...
VenusaurMegaAnimation::	INCLUDE "gfx/pokemon/venusaur_mega/anim.asm"
VenusaurGigaAnimation::	INCLUDE "gfx/pokemon/venusaur_giga/anim.asm"
...
MrmimeAnimation:	INCLUDE "gfx/pokemon/mrmime/anim.asm"
