...
VenusaurMegaAnimationIdle::	INCLUDE "gfx/pokemon/venusaur_mega/anim_idle.asm"
VenusaurGigaAnimationIdle::	INCLUDE "gfx/pokemon/venusaur_giga/anim_idle.asm"
...
MrmimeAnimationIdle:	INCLUDE "gfx/pokemon/mrmime/anim_idle.asm"
