	...
	tilecoll STAIRS_RIGHT_UP_HALF, STAIRS_LEFT_DOWN, STAIRS_RIGHT_UP_HALF, LEFT_WALL ; 7d
	tilecoll STAIRS_RIGHT_DOWN, STAIRS_LEFT_UP_HALF, RIGHT_WALL, STAIRS_LEFT_UP_HALF ; 7e
	...
	tilecoll WALL, FLOOR, STAIRS_RIGHT_UP_TOP, STAIRS_LEFT_DOWN ; ab
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; ac
	tilecoll WALL, WALL, WALL, STAIRS_RIGHT_UP_MID ; ad
	tilecoll STAIRS_RIGHT_UP_TOP, STAIRS_LEFT_DOWN, STAIRS_RIGHT_UP_TOP, LEFT_WALL ; ae
	tilecoll STAIRS_RIGHT_UP_MID, WALL, WALL, WALL ; af
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; b0
	tilecoll STAIRS_RIGHT_UP_BOTTOM, STAIRS_RIGHT_UP_MID, STAIRS_RIGHT_UP_BOTTOM, WALL ; b1
	tilecoll STAIRS_RIGHT_UP_MID, WALL, WALL, WALL ; b2
	tilecoll STAIRS_RIGHT_UP_MID, STAIRS_RIGHT_UP_FLAT, STAIRS_RIGHT_UP_MID, LEFT_WALL ; b3
