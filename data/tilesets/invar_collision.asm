	...
	tilecoll STAIRS_RIGHT_UP_MID, STAIRS_LEFT_DOWN, STAIRS_RIGHT_UP_MID, LEFT_WALL ; 7d
	tilecoll STAIRS_RIGHT_DOWN, STAIRS_LEFT_UP_MID, RIGHT_WALL, STAIRS_LEFT_UP_MID ; 7e
