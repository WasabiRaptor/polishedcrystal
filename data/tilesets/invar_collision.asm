	...
	tilecoll FLOOR, FLOOR, FLOOR, STAIRS_RIGHT_UP ; 7c
	tilecoll WALL, STAIRS_LEFT_DOWN, WALL, FLOOR ; 7d
	tilecoll STAIRS_RIGHT_DOWN, WALL, FLOOR, WALL ; 7e
	tilecoll FLOOR, FLOOR, STAIRS_LEFT_UP, FLOOR ; 7f
