...
MapGroup_CableClub:
	...
	map TradeCenter,  TILESET_GATE,       INDOOR | FOLLOWER_DISABLE, SPECIAL_MAP, MUSIC_CHERRYGROVE_CITY, 1, PALETTE_DAY, FISHGROUP_SHORE
	map Colosseum,    TILESET_GATE,       INDOOR | FOLLOWER_DISABLE, SPECIAL_MAP, MUSIC_CHERRYGROVE_CITY, 1, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Overworld:
	map DanielsTown, TILESET_INVAR, TOWN, DANIELS_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Bridge,      TILESET_INVAR, TOWN, TANI_RIVER_2,  MUSIC_ROUTE_37,      FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AsaokaCity,  TILESET_INVAR, TOWN, ASAOKA_CITY,  MUSIC_VIOLET_CITY,   FALSE, PALETTE_AUTO, FISHGROUP_SHORE

	map GelidRavine2, TILESET_INVAR, TOWN, GELID_RAVINE, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map GelidRavine,  TILESET_INVAR, TOWN, GELID_RAVINE, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map OuestPathway, TILESET_INVAR, TOWN, OUEST_PATHWAY, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map MinamiWetlandsEntrance, TILESET_INVAR, TOWN, MINAMI_WETLANDS, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MinamiWetlands,         TILESET_INVAR, TOWN, MINAMI_WETLANDS, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

	map SylvanTrail1, TILESET_INVAR, TOWN, SYLVAN_TRAIL, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SylvanTrail2, TILESET_INVAR, TOWN, SYLVAN_TRAIL, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Lake1, TILESET_INVAR, TOWN, CRYSTALINE_LAKE_1, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Lake2, TILESET_INVAR, TOWN, CRYSTALINE_LAKE_2, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Lake3, TILESET_INVAR, TOWN, CRYSTALINE_LAKE_1, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
