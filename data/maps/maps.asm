...
MapGroup_Overworld:
	...
	map Ravine, TILESET_INVAR, TOWN, SPECIAL_MAP, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RouteNE2, TILESET_INVAR, TOWN, SPECIAL_MAP, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

	map KubotaTown, TILESET_INVAR, TOWN, KUBOTA_TOWN, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

	map RouteW1, TILESET_INVAR, TOWN, SPECIAL_MAP, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

	map AshPlains1, TILESET_INVAR, TOWN, ASH_PLAINS, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AshPlains2, TILESET_INVAR, TOWN, ASH_PLAINS, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AshPlains3, TILESET_INVAR, TOWN, ASH_PLAINS, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map RouteSW2, TILESET_INVAR, TOWN, SPECIAL_MAP, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
